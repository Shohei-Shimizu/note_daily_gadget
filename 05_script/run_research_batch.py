...
TASKS = [
    ...
    {
        "date": "2026-06-01",
        "title": "部屋干しを快適に。梅雨に負けない「衣類乾燥・除湿機」 7 選",
        "target_count": 7,
        "editorial_summary": "梅雨時期の部屋干し対策として、衣類乾燥機能を備えた除湿機を中心に選定。メーカー重複を避け、サーキュレーター付き、コンパクト、ハイブリッド式、大容量コンプレッサー式など、部屋の広さや乾燥スピードに応じて選び分けられる構成にした。",
        "query_reasons": {
            "アイリスオーヤマ 衣類乾燥除湿機 IJD-I50": "サーキュレーター一体型で洗濯物に風を当てやすく、部屋干しの時短という記事テーマに合うため採用。",
            "シャープ 衣類乾燥除湿機 CV-R60": "省スペース設計とプラズマクラスター搭載で、洗濯物の乾燥と部屋干し臭対策をまとめて訴求しやすいため採用。",
            "パナソニック 衣類乾燥除湿機 F-YHVX120": "ハイブリッド式の高機能モデルとして、年間を通じて使いたい読者向けの上位候補になるため採用。",
            "コロナ 衣類乾燥除湿機 CD-P63A": "コンプレッサー式の定番モデルで、梅雨から夏の湿気対策として扱いやすいため採用。",
            "三菱 衣類乾燥除湿機 MJ-P180RX": "大容量・ハイパワー枠として、洗濯物が多い家庭や広めの部屋向けに差別化できるため採用。",
            "山善 衣類乾燥除湿機 YDC-C60": "基本機能を押さえたシンプルな衣類乾燥除湿機として、価格と実用性のバランス枠に適しているため採用。",
            "ツインバード 衣類乾燥除湿機 JS-E955W": "キャスター付きの扱いやすいコンプレッサー式として、設置場所を変えながら使う読者に提案しやすいため採用。"
        },
        "queries": [
            {"query": "アイリスオーヤマ 衣類乾燥除湿機 IJD-I50", "include": ["アイリスオーヤマ", "IJD-I50"]},
            {"query": "シャープ 衣類乾燥除湿機 CV-R60", "include": ["シャープ", "CV-R60"]},
            {"query": "パナソニック 衣類乾燥除湿機 F-YHVX120", "include": ["パナソニック", "F-YHVX120"]},
            {"query": "コロナ 衣類乾燥除湿機 CD-P63A", "include": ["CORONA", "CD-P63A"]},
            {"query": "三菱 衣類乾燥除湿機 MJ-P180RX", "include": ["Mitsubishi", "MJ-P180RX"]},
            {"query": "山善 衣類乾燥除湿機 YDC-C60", "include": ["山善", "YDC-C60"]},
            {"query": "ツインバード 衣類乾燥除湿機 JS-E955W", "include": ["TWINBIRD", "JS-E955W"]},
        ],
    },
    {
        "date": "2026-07-01",
        "title": "ネッククーラーで猛暑対策。首元を冷やす「最新ファン」 7 選",
        "target_count": 7,
        "queries": [
            {"query": "ソニー REON POCKET PRO RNPK-P1", "include": ["REON POCKET PRO"]},
            {"query": "TORRAS COOLiFY Cyber ネッククーラー", "include": ["COOLIFY", "Cyber"]},
            {"query": "RANVOO ネッククーラー AICE LITE Max", "include": ["RANVOO", "AICE LITE Max"]},
            {"query": "THANKO ネッククーラー Evo", "include": ["ネッククーラー", "Evo"]},
            {"query": "ドウシシャ Tempo Loop ネッククーラー", "include": ["Tempo", "Loop"]},
            {"query": "MOOLOTY ネッククーラー 冷却プレート", "include": ["MOOLOTY", "ネッククーラー"]},
            {"query": "サンコー ネッククーラー Slim", "include": ["ネッククーラー", "Slim"]},
        ],
    },
    {
        "date": "2026-07-02",
        "title": "PC の熱暴走を防ぐ。夏に必須の「ノート PC クーラー」 6 選",
        "target_count": 6,
        "queries": [
            {"query": "IETS GT600 ノートパソコン 冷却台", "include": ["GT600"]},
            {"query": "llano V12 ノートパソコン 冷却台", "include": ["V12"]},
            {"query": "KLIM Everest ノートパソコン 冷却台", "include": ["KLIM", "Everest"]},
            {"query": "Cooler Master NotePal X-Slim II", "include": ["NotePal", "X-Slim"]},
            {"query": "エレコム ノートPC クーラー SX-CL24LBK", "include": ["SX-CL24"]},
            {"query": "サンワサプライ ノートパソコンクーラー 400-CLN025", "include": ["400-CLN025"]},
        ],
    },
    {
        "date": "2026-07-03",
        "title": "汗や雨に強い。防水性能に優れた「完全ワイヤレス」 6 選",
        "target_count": 6,
        "queries": [
            {"query": "Jabra Elite 8 Active Gen 2", "include": ["Elite 8 Active"]},
            {"query": "JBL ENDURANCE RACE 2", "include": ["ENDURANCE RACE 2"]},
            {"query": "Soundcore Sport X20", "include": ["Sport X20"]},
            {"query": "EarFun Air Pro 4", "include": ["Air Pro 4"]},
            {"query": "Shokz OpenFit 2", "include": ["OpenFit 2"]},
            {"query": "AVIOT TE-W1-PNK", "include": ["TE-W1"]},
        ],
    },
    {
        "date": "2026-07-04",
        "title": "車内の温度上昇を抑える。猛暑に効く「車載クーラー・ファン」 5 選",
        "target_count": 5,
        "queries": [
            {"query": "KEYNICE 車載扇風機 後部座席", "include": ["車載", "扇風機"]},
            {"query": "エマーソン 車内用扇風機 EM-347", "include": ["EM-347"]},
            {"query": "メルテック カーファン CF-106", "include": ["CF-106"]},
            {"query": "大自工業 車載扇風機 クリップ", "include": ["扇風機"]},
            {"query": "ボンフォーム 車載扇風機 角度調整", "include": ["扇風機"]},
        ],
    },
    {
        "date": "2026-07-05",
        "title": "夏の思い出を映画風に。スマホ操作を支える「ジンバル」 6 選",
        "target_count": 6,
        "queries": [
            {"query": "DJI Osmo Mobile 7P", "include": ["Osmo Mobile 7P"]},
            {"query": "Insta360 Flow 2 Pro", "include": ["Flow 2 Pro"]},
            {"query": "hohem M7 スマホジンバル", "include": ["hohem", "M7"]},
            {"query": "ZHIYUN CINEPEER SMOOTH 5E", "include": ["ZHIYUN", "SMOOTH 5E"]},
            {"query": "FeiyuTech SCORP Mini P", "include": ["SCORP Mini P"]},
            {"query": "AOCHUAN Smart X Pro", "include": ["Smart X Pro"]},
        ],
    },
    {
        "date": "2026-07-06",
        "title": "風切り音をカット。動画の音質を上げる「外部マイク」 5 選",
        "target_count": 5,
        "queries": [
            {"query": "RODE Wireless Micro USB-C", "include": ["ワイヤレス マイクロ", "USB-C"]},
            {"query": "RODE Wireless PRO", "include": ["Wireless PRO"]},
            {"query": "Hollyland LARK M2", "include": ["LARK M2"]},
            {"query": "DJI Mic Mini ワイヤレスマイク", "include": ["DJI Mic Mini"]},
            {"query": "BOYA mini ワイヤレスマイク", "include": ["BOYA", "mini"]},
        ],
    },
    {
        "date": "2026-07-07",
        "title": "旅先からライブ配信。高速「モバイルルーター」セット 6 選",
        "target_count": 6,
        "queries": [
            {"query": "NEC Aterm MR51FN モバイルルーター", "include": ["MR51FN"]},
            {"query": "富士ソフト FS040W モバイルルーター", "include": ["FS040W"], "exclude": ["ケース", "フィルム"]},
            {"query": "TP-Link M8550 モバイルルーター", "include": ["M8550"], "exclude": ["ケース", "フィルム"]},
            {"query": "GlocalMe Numen Air モバイルルーター", "include": ["Numen Air"]},
            {"query": "TP-Link M7450 モバイルルーター", "include": ["M7450"], "exclude": ["ケース", "フィルム", "バッテリー"]},
            {"query": "ピクセラ PIX-MT110 モバイルルーター", "include": ["PIX-MT110"]},
        ],
    },
]
